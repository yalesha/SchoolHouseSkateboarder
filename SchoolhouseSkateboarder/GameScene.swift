...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func setupLabels() {
        ...
        scoreTextLabel.position = CGPoint(x: 70.0, y: frame.size.height - 20.0)
        ...
        scoreLabel.position = CGPoint(x: 70.0, y: frame.size.height - 40.0)
        ...
        highScoreTextLabel.position = CGPoint(x: frame.size.width - 70.0, y: frame.size.height - 20.0)
        ...
        highScoreLabel.position = CGPoint(x: frame.size.width - 70.0, y: frame.size.height - 40.0)
